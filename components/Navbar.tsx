  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 py-4 transition-all duration-300 ease-in-out bg-black/60 backdrop-blur-sm">
        <div>
          <Link href="/" className="logo font-display text-h2">
            <img
              src="logo.png"
              alt="Logo"
        ...
        <div>
          <div className="relative">
            {/* Desktop Navigation */}
            <ul className="desktop-nav hidden md:flex space-x-8 items-center text-white font-body text-h3">
              <li>
              ...
              <li>
                <Link href="/contact-us">
                  <button
                    ref={buttonRef}
                    className="glow-button hidden md:flex font-body text-h3"
                  >
                    Get in Touch
                  </button>
                </Link>
